...
export const metadata = {
    title: 'Braselton, GA Pallet Supply & Sourcing | Jackson County',
...
export default function BraseltonGAPage() {
    const breadcrumbJson = {
        ...
        "itemListElement": [
            ...
            { "@type": "ListItem", "position": 4, "name": "Braselton", "item": "https://a3pallet.com/service-areas/braselton-ga" }
        ]
    };
    ...
    return (
        <div className="container mx-auto py-16 px-4">
            ...
            <div className="mb-24 bg-primary/5 border-2 border-primary/10 rounded-3xl p-8 flex flex-col md:flex-row items-center justify-between gap-6">
                <div>
                    <h3 className="text-xl font-bold mb-2 text-primary">Need Custom Pallets in Braselton?</h3>
