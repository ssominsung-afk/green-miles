...
export const metadata = {
    title: 'Buford, GA Pallet Supply & Sourcing | Northeast Gwinnett',
...
export default function BufordGAPage() {
    const breadcrumbJson = {
        ...
        "itemListElement": [
            ...
            { "@type": "ListItem", "position": 4, "name": "Buford", "item": "https://a3pallet.com/service-areas/buford-ga" }
        ]
    };
    ...
    return (
        <div className="container mx-auto py-16 px-4">
            ...
            <div className="mb-24 bg-primary/5 border-2 border-primary/10 rounded-3xl p-8 flex flex-col md:flex-row items-center justify-between gap-6">
                <div>
                    <h3 className="text-xl font-bold mb-2 text-primary">Need Custom Pallets in Buford?</h3>
