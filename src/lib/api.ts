...
const CRM_URL = process.env.NEXT_PUBLIC_CRM_URL || "https://script.google.com/macros/s/AKfycbyYoNBLRJEDYSVqql-aXM_tjHdoWNYrDMRWR8NVD3vt83m7_OtF-AGcS4sp_WBqhkoR/exec";
